(function (global, undefined) {
    ...
    var Terminal = Terminal || function(containerID, options) {
        ...
        var defaults = {
            welcome: '',
            prompt: '<span class="user">pixis</span>@<span class="hostname">hackndo</span>:',
            separator: '$',
            theme: 'interlaced'
        };
                            ...
                            'content': [
                                {
                                    'name': 'hackndo_fr',
                                    'type': fileType.LINK,
                                    'content': 'https://beta.hackndo.com'
                                },
                                {
                                    'name': 'hackndo_en',
                                    'type': fileType.LINK,
                                    'content': 'https://en.hackndo.com'
                                },
                                {
                                    'name': 'prendrelatangente',
                                    'type': fileType.LINK,
                                    'content': 'https://prendrelatangente.com/'
                                }
                            ]
                        },
                        {
                            ...
                            'content': [
                                {
                                    'name': 'Resume_FR',
                                    'type': fileType.LINK,
                                    'content': 'https://cv.hackndo.com'
                                },
                                {
                                    'name': 'Resume_EN',
                                    'type': fileType.LINK,
                                    'content': 'https://resume.hackndo.com'
                                },
                            ]
                        },
                        {
                            ...
                            'content': [
                                {
                                    'name':'lsassy',
                                    'type':fileType.LINK,
                                    'content':'https://github.com/Hackndo/lsassy',
                                },
                                {
                                    'name':'Krack_POC',
                                    'type':fileType.LINK,
                                    'content':'https://github.com/Hackndo/krack-poc',
                                },
                                {
                                    'name':'Discord-IRC Sync',
                                    'type':fileType.LINK,
                                    'content':'https://github.com/Hackndo/discord-irc-sync',
                                },
                                {
                                    'name':'Slack-IRC Sync',
                                    'type':fileType.LINK,
                                    'content':'https://github.com/Hackndo/slack-irc-sync',
                                },
                                {
                                    'name':'misc',
                                    'type':fileType.DIRECTORY,
                                    'content':[
                                        {
                                            'name':'ExecShellcode',
                                            'type':fileType.LINK,
                                            'content':'https://github.com/Hackndo/misc/tree/master/execshellcode',
                                        },
                                        {
                                            'name':'Address Finder',
                                            'type':fileType.LINK,
                                            'content':'https://github.com/Hackndo/misc/tree/master/findaddr',
                                        },
                                        {
                                            'name':'PyTools (WIP)',
                                            'type':fileType.LINK,
                                            'content':'https://github.com/Hackndo/misc/tree/master/pytools',
                                        },
                                        {
                                            'name':'CryptoDetector (WIP)',
                                            'type':fileType.LINK,
                                            'content':'https://github.com/Hackndo/misc/tree/master/cryde',
                                        },
                                    ]
                                },
                            ]
                            ...
                            'content': [
                                {
                                    'name':'twitter',
                                    'type':fileType.LINK,
                                    'content':'https://twitter.com/HackAndDo',
                                },
                                {
                                    'name':'github',
                                    'type':fileType.LINK,
                                    'content':'https://github.com/hackndo',
                                },
                                {
                                    'name':'discord',
                                    'type':fileType.LINK,
                                    'content':'https://discordapp.com/invite/9At6SUZ',
                                },
                            ]
                        },
                        {
                        	...
                        	'content': `Hi,
                        		...
                        		Oh, by the way, can you find the string behind 6dc7044b56e99cd0fdd7d88229add5df ?
        ...
        var availableCommands = {
           ...
           "challenge": {
                 "req_args":[],
                 "opt_args":[],
                 "description":"Reveal a challenge",
                 "usage":"challenge"
            },
           "h, help": {
                 "req_args":[],
